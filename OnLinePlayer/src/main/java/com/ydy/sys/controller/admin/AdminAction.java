package com.ydy.sys.controller.admin;
...
public class AdminAction {
	...
	public String center(ModelMap map) {
		...
		sb.append("	<div class='right'>视频管理系统 1.0.0</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>作者：</p></div>");
		sb.append("	<div class='right'>廖发</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>联系方式：</p></div>");
		sb.append("	<div class='right'>15297978331</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>邮箱：</p></div>");
		sb.append("	<div class='right'>1025157464@qq.com</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
