package com.ydy.sys.dao.user_info;
...
public interface IUserInfoDAO {
	...
	UserInfo selectUserByLoginName(String szLoginName);

    String selectUser_info(String szLoginName);

    void batchUpdateSize(Map<String, Object> param);
}