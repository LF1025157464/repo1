package com.ydy.sys.dao.media_info;
...
public interface IMediaInfoDAO {
	 ...
	 * 视频存储
	 */
	int saveVideo(UpLoadVideoInfo upLoadVideoInfo);

    List<MediaInfo> selectListMediaByUser(Map<String, Object> param);

	List<Map<String,Object>> listMedia(String id);


    void deleteMediaByUserAndMediaId(MediaInfo mediaInfo);

    void Update(Map<String, Object> param);

    List<Map<String,Object>> selectMediaByUserId(String userId);
}