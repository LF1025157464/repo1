package com.ydy.sys.service.qiniu_info;
...
import com.ydy.sys.dao.qiniu_info.IQiniuInfoDAO;
...
//				System.out.println(putRet.hash);
				...
				//ps6wjrusu.bkt.clouddn.com0b6f5ae1b0854db08ec61d5e859aeba7
				String http="http://";
...
//		System.out.println(request.headers());
	 ...
	 * @throws QingException
	 */
	public String uploadVideo(MultipartFile file, QiniuInfo qiniuInfo) throws IOException, QingException {
		/**
		 * 构造一个带指定Zone对象的配置类
		 * 华东 : Zone.zone0()
		 * 华北 : Zone.zone1()
